...
public class VistaPrevia extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPContenidoLayout.setVerticalGroup(
            ...
            .addGroup(jPContenidoLayout.createSequentialGroup()
                .addComponent(panelpdf, javax.swing.GroupLayout.DEFAULT_SIZE, 714, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void Consulta()
    {
        ...
        String sSQL="SELECT * FROM documentos WHERE IDNoExpediente=" + "'" + BDdocumentos.getNoExpediente() +"'";
        try 
        {
...
//              imagen = new JLabel(new ImageIcon(getClass().getResource("icon-pdf.png")));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a.AbrirEliminadorArchivos(BDdocumentos.getNoExpediente());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        AgregarArchivoExp b = new AgregarArchivoExp();
        b.AbrirAgregarArchivos(BDdocumentos.getNoExpediente());
