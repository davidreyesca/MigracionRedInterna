...
public class VistaPreviaLectura extends javax.swing.JPanel {
    ...
    public VistaPreviaLectura() {
        ...
        jLNombreCarpeta.setText(String.valueOf(AbrirExpediente.getNoExpedinte()));
    }
    ...
    public static void Consulta()
    {
        ...
        String sSQL="SELECT * FROM documentos WHERE IDNoExpediente=" + "'" + AbrirExpediente.getNoExpedinte() +"'";
        try 
        {
...
//                        }
    ...
    private void jBVerPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBVerPDFActionPerformed
        ...
        a.AbrirEliminadorArchivos(AbrirExpediente.getNoExpedinte());  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        b.AbrirAgregarArchivos(AbrirExpediente.getNoExpedinte());
